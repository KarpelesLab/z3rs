...
| 3     | `model` / `tactic`           | ⬜     |       |
| 4     | `sat`                        | 🟨     | CDCL solver (2-watched literals, 1-UIP learning, backjumping, VSIDS, Luby restarts, phase saving, **learnt-clause activity + lazy DB reduction**, **assumptions**, **conflict budget → sound `unknown`**), Tseitin AST→CNF, DIMACS frontend · to do: unsat cores, in-processing, `sat_smt` |
